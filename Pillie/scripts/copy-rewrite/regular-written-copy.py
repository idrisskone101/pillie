...
SPECIAL_DE: dict[tuple[str, str], str] = {
    ...
    ("Commerce", "paywall.subtitle"): (
        "Pillie Plus pingt weiter, bis du heute einträgst, und kann Apps bis zum Check-in pausieren."
    ),
    ("Commerce", "paywall.upsell.custom_messages.body"): (
        "Schreib den Ping in deinen Worten. Plus ändert den täglichen und den letzten."
    ),
    ("Localizable", "onboarding.welcome.title"): "Der Wecker für deine Pille.",
    ("Localizable", "onboarding.welcome.subtitle"): "Du kannst sie nicht wegwischen.",
    ("Localizable", "today.protection.off.detail.pill"): (
        "Erinnerungen laufen. Plus pausiert Apps bis zum Check-in."
    ),
    ...
    ("Localizable", "onboarding.method.title"): "Wähl deine Methode.",
    ("Localizable", "onboarding.cycle_position.title"): "Wo stehst du in deiner Routine?",
    ("Localizable", "onboarding.reminder_time.title"): "Wähl eine Erinnerungszeit.",
...
SPECIAL_IT: dict[tuple[str, str], str] = {
    ...
    ("Commerce", "paywall.subtitle"): (
        "Pillie Plus continua a mandare ping finché non registri oggi, e può mettere in pausa le app fino al check-in."
    ),
    ("Commerce", "paywall.upsell.custom_messages.body"): (
        "Scrivi il ping con le tue parole. Plus cambia quello giornaliero e l'ultimo."
    ),
    ("Localizable", "onboarding.welcome.title"): "La sveglia per la tua pillola.",
    ("Localizable", "onboarding.welcome.subtitle"): "Non puoi scartarlo.",
    ("Localizable", "today.protection.off.detail.pill"): (
        "I promemoria ci sono. Plus mette in pausa le app fino al check-in."
    ),
    ("Localizable", "today.protection.off.detail.patch.apply"): (
        "I promemoria ci sono. Plus mette in pausa le app fino al check-in."
    ),
...
SPECIAL_EN: dict[tuple[str, str], str] = {
    ...
    ("Notifications", "notification.reminder.patch.body"): (
        "Hey, quick check-in. Log your patch when you're done"
    ),
    ("Notifications", "notification.reminder.ring.body"): (
        "Hey, quick check-in. Log your ring when you're done"
    ),
    ("Notifications", "notification.followup.body"): (
        "Hey, quick check-in is still open. Log it when you're ready"
    ),
}
