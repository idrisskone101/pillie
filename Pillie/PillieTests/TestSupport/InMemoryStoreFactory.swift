...
enum InMemoryStoreFactory {
    ...
    private static func resetDefaults() {
        ...
        [
            ...
            "pillie_last_call_reminder_enabled",
            "pillie_last_call_reminder_hour",
            "pillie_last_call_reminder_minute",
            "pillie_custom_due_reminder_title",
            "pillie_custom_due_reminder_body",
            "pillie_custom_retry_reminder_title",
            "pillie_custom_retry_reminder_body",
            "pillie_custom_last_call_reminder_title",
            "pillie_custom_last_call_reminder_body",
