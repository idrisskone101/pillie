...
Status: draft for review. Nothing in the string catalogs follows this yet.
...
| follow-up reminders | the repeats after the first reminder | extra pings, smart notifications |
